...
const ChatLayout = ({defaultLayout=[320,480]}:ChatLayoutProps) => {
  ...
  return (
    ...
    <ResizablePanelGroup 
        ...
        className='h-full w-full items-stretch bg-background rounded-lg'
    ...
    >
       <ResizablePanel
				...
				collapsedSize={8}
				collapsible={true}
				minSize={isMobile === null ? 24 : (isMobile ? 0 : 24)}
				maxSize={isMobile === null ? 30 : (isMobile ? 8 : 30)}
				onCollapse={() => {
					setIsCollapsed(true);
        ...
        <ResizableHandle withHandle />
        			...
        			<ResizablePanel defaultSize={defaultLayout[1]} minSize={30} collapsible={false}>
