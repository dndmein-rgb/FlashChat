import { Image as ImageIcon, ThumbsUp, Loader } from "lucide-react";
...
const ChatBottomBar = () => {
  ...
  const playRandomKeysStrokeSound=()=>{
      ...
      <AnimatePresence>
        ...
        {message.trim() || isPending ? (
          <Button
            ...
            disabled={isPending}
          >
            {!isPending && <SendHorizontal size={20} className="text-muted-foreground" />}
